...
function WorkspacePreview() {
  return (
    <div className="hidden min-h-[38rem] overflow-hidden rounded-2xl border border-white/10 bg-[#071013]/90 shadow-2xl shadow-black/40 lg:block">
      <div className="flex h-11 items-center gap-3 border-b border-white/10 bg-black/35 px-4">
        ...
        <div className="flex-1 text-center text-[10px] font-semibold uppercase tracking-[0.26em] text-slate-500">
          secure workspace
        </div>
      </div>
      ...
      <div className="grid h-[calc(38rem-2.75rem)] grid-cols-[180px_minmax(0,1fr)]">
        <aside className="border-r border-white/10 bg-black/30 p-4">
          <div className="mb-4 text-[10px] font-semibold uppercase tracking-[0.24em] text-slate-500">Explorer</div>
          ...
          <div className="mt-8 rounded-xl border border-amber-300/20 bg-amber-300/10 p-3">
        ...
        <section className="grid min-w-0 grid-rows-[1fr_160px] bg-[#071519]">
          <div className="p-6 font-mono text-sm">
            <div className="mb-5 flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
          ...
          <div className="border-t border-white/10 bg-black/45 p-4">
            ...
            <div className="rounded-xl border border-white/10 bg-black/35 p-3 text-xs leading-6 text-teal-100">
      ...
      <div className="relative z-10">
        <header className="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 md:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold tracking-tight text-white">CodeVerse</span>
          </Link>

          <Link
            href="/"
            className="inline-flex h-10 items-center justify-center rounded-xl border border-white/10 px-4 text-sm font-bold text-slate-200 transition hover:bg-white/10"
          >
        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-4 pb-12 pt-4 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="mx-auto w-full max-w-lg rounded-2xl border border-white/10 bg-[#081113]/92 p-6 shadow-2xl shadow-black/40 backdrop-blur md:p-8">
            <div className="mb-7">
              <div className="mb-4 inline-flex items-center gap-2 rounded-xl border border-teal-300/20 bg-teal-300/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-teal-100">
            ...
            <div className="mt-6 grid gap-3 rounded-xl border border-white/10 bg-black/25 p-4 text-sm text-slate-400 sm:grid-cols-2">
