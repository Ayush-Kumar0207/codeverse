      ...
      <div className="relative z-10">
        <header className="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 md:px-8">
          <Link href="/" className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-300 text-black shadow-lg shadow-teal-300/20">
              <Command className="h-6 w-6" />
            </span>
            <span className="text-xl font-semibold text-white">CodeVerse</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="inline-flex h-10 items-center justify-center rounded-xl bg-white/[0.06] px-3 text-sm font-bold text-white transition hover:bg-white/10 sm:px-4"
            >
              Sign In
            </Link>
          </div>
        ...
        <section className="mx-auto grid max-w-7xl gap-6 px-4 pb-12 pt-4 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-[#081113]/92 p-6 shadow-2xl shadow-black/35 backdrop-blur md:p-8">
              <div className="mb-5 inline-flex items-center gap-2 rounded-xl border border-teal-300/20 bg-teal-300/10 px-3 py-1 text-xs font-semibold uppercase text-teal-100">
                ...
                {launchModes.map((mode) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "group flex min-h-24 w-full items-start gap-4 rounded-2xl border p-4 text-left transition",
                        isActive
                          ? mode.panel
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span className="flex flex-wrap items-center gap-2">
                          <span className="text-base font-semibold text-white">{mode.title}</span>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {activeMode.checks.map((check) => (
                <div key={check} className="rounded-2xl border border-white/10 bg-black/30 p-4">
          ...
          <div className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#081113]/92 shadow-2xl shadow-black/40 backdrop-blur">
              <div className="flex h-11 items-center gap-3 border-b border-white/10 bg-black/35 px-4">
                ...
                <div className="min-w-0 flex-1 text-center text-[10px] font-semibold uppercase text-slate-500">
                  launch preview
                </div>
              </div>
              ...
              <div className="grid min-h-[26rem] grid-cols-[150px_minmax(0,1fr)]">
                <aside className="border-r border-white/10 bg-black/30 p-4">
                  <div className="mb-4 text-[10px] font-semibold uppercase text-slate-500">Files</div>
                  {activeMode.files.map((file, index) => (
                    <div
                      key={file}
                      className={cn(
                        "mb-2 flex h-10 items-center gap-2 rounded-xl px-3 text-sm",
                ...
                <section className="grid min-w-0 grid-rows-[1fr_110px] bg-[#071519]">
                  <div className="p-5 font-mono text-sm">
                    <div className="mb-5 flex items-center gap-2 text-[10px] font-semibold uppercase text-slate-500">
                  ...
                  <div className="border-t border-white/10 bg-black/45 p-4">
                    <div className="mb-2 flex items-center gap-2 text-[10px] font-semibold uppercase text-slate-500">
                      <TerminalSquare className="h-4 w-4 text-amber-300" />
                      Next action
                    </div>
                    <div className="rounded-xl border border-white/10 bg-black/35 p-3 text-xs leading-5 text-teal-100">
                      {selectedMode === "demo"
            ...
            <div className="rounded-2xl border border-white/10 bg-[#081113]/92 p-6 shadow-2xl shadow-black/40 backdrop-blur">
              {selectedMode === "demo" ? (
                <div className="space-y-4">
                  <div>
                    <h2 className="text-2xl font-semibold text-white">Explore before signing up.</h2>
                  ...
                  <Link
                    href="/demo"
                    className="inline-flex h-12 w-full items-center justify-center rounded-xl bg-teal-300 px-5 text-sm font-semibold text-black shadow-xl shadow-teal-300/15 transition hover:bg-teal-200"
                  >
                    Try Demo Workspace
                  ...
                  <button
                    ...
                    className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-white/10 px-5 text-sm font-bold text-slate-200 transition hover:bg-white/10"
                  >
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div>
                    <h2 className="text-2xl font-semibold text-white">Create your organizer profile.</h2>
                    <p className="mt-2 text-sm leading-6 text-slate-400">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="mt-2 h-12 w-full rounded-xl border border-white/10 bg-black/35 px-4 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-teal-300/60 focus:ring-2 focus:ring-teal-300/15"
                  ...
                  <button
                    ...
                    className="inline-flex h-12 w-full items-center justify-center rounded-xl bg-teal-300 px-5 text-sm font-semibold text-black shadow-xl shadow-teal-300/15 transition hover:bg-teal-200 disabled:cursor-not-allowed disabled:opacity-70"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <a
                      ...
                      className="flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-4 text-sm font-bold text-slate-100 transition hover:border-teal-300/40 hover:bg-teal-300/10"
                    >
                    ...
                    <a
                      ...
                      className="flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-4 text-sm font-bold text-slate-100 transition hover:border-amber-300/40 hover:bg-amber-300/10"
                    >
                      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-white text-sm font-semibold text-slate-900">
                        G
                      </span>
                      Google
                    </a>
